...
urlpatterns = [path('', views.PizzeriaListAPIView.as_view(), name='pizzeria_list'),
               ...
               path('update/<int:id>/', views.PizzeriaRetrieveUpdateAPI.as_view(), name='pizzeria_update'),
               path('delete/<int:id>/', views.PizzeriaDestroyAPI.as_view(), name='pizzeria_delete')
               ]
